...
eval("\r\nfunction logger(workout,index,array){\r\n    console.log(workout,index,array);\r\n}\r\n\r\nfunction mapTest(array,callBack){\r\n    array.map(callBack);\r\n}\r\n\r\nconst array = [\r\n    'hello',\r\n    'world',\r\n    'foo',\r\n    'bar'\r\n]\r\n\r\nmapTest(array,logger);\n\n//# sourceURL=webpack:///./public/javascript/test.js?");
